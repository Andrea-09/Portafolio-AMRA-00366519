...
int main(){
    ...
    for (int i = 0; i < 5; i++) {
        ...
        if(cartaJug1.numero > cartaJug2.numero || cartaJug1.numero == 1){
            cout << "Ronda gana Jugador 1!\n\n"; contador1++;
        }
        else{
            if(cartaJug2.numero > cartaJug1.numero || cartaJug2.numero == 1)
...
void mostrarCarta(Carta unaCarta){
    ...
    switch (unaCarta.palo){
        case Corazones: cout << "corazones rojos"; break;
        case Diamantes: cout << "diamantes rojos"; break;
        case Treboles: cout << "treboles negros"; break;
        case Picas: cout << "picas negras"; break;
    }
    cout << endl;
}
